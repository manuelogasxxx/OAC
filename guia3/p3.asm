;nombre    : p3.asm
;Propósito : Saber si un número ingresado es perfecto
...
section .data
	msjTitulo: db "Verificar si un numero es perfecto",10,0
    msg:    db "Ingrese un valor::",10,0
    sumaMsg: db "Suma de divisores propios: ",0
    msgSi: db "SI es perfecto",10,0
    msgNo: db "NO es perfecto",10,0
    suma:   dd 0
    temp: dd 0
